        ...
        <View style={style.centeredView}>
          <View style={style.modalView}>
            {isSet && downloadProgress === 0 ? (
              ...
              >
                <Text
                  style={{ fontSize: 13, color: "#3399FF" }}
        ...
        <View style={style.headerCardContainer}>
          ...
          >
            <Text
              ...
              darkColor="white"
              style={{ marginLeft: 20, fontWeight: "bold", marginTop: 10 }}
            >
              Similar Tags
            </Text>
          </View>
          <View style={{ flexDirection: "row" }}>
            <FlatList
              data={Tags}
              renderItem={({ item }) => (
                <HeaderImage Title={item.Title} Poster={item.MainImage} />
              )}
              horizontal
            />
          </View>
